...
Simple PowerShell script for use in VMs to test PRs in the [Windows Package Manager Community Repository](https://github.com/microsoft/winget-pkgs). Does not require a clone of winget-pkgs.
