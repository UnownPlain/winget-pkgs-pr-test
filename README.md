...
Fast and simple PowerShell script to test PRs in the [Windows Package Manager Community Repository](https://github.com/microsoft/winget-pkgs) in a VM. Does not require a clone of winget-pkgs.
